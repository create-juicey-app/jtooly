  ...
  return (
    <div>
      <Typography variant="h2">
        THIS IS BROKEN, AND STILL WILL BE BROKEN
      </Typography>
      <Typography variant="h5">
        DUE TO RECENT UPDATES TO HOW YOUTUBE IS LOADING THEIR VIDEOS, MY OWN API
        IS NOT WORKING ANYMORE, THIS WILL BE FIXED WHEN THE REST OF THE WEBSITE
        IS MADE
      </Typography>
      <br></br>
      <br></br>
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
          <Paper sx={{ p: 2, mr: 1 }} elevation={3}>
            ...
            />
            {quality !== null && <Typography>{labels[quality]}</Typography>}
          </Paper>
        </Box>
            ...
            <div disabled>
              <Tooltip title="Mute Audio">
                <Checkbox
                  ...
                  checkedIcon={<VolumeOffRoundedIcon />}
                />
              </Tooltip>
            </div>
          </Paper>
